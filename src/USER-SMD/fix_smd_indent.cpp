...
FixSMDIndent::FixSMDIndent(LAMMPS *lmp, int narg, char **arg) :
  Fix(lmp, narg, arg),
...
void FixSMDIndent::setup(int vflag)
{
...
void FixSMDIndent::min_setup(int vflag)
{
  post_force(vflag);
}
...
void FixSMDIndent::post_force(int vflag)
{
...
void FixSMDIndent::post_force_respa(int vflag, int ilevel, int iloop)
{
...
void FixSMDIndent::min_post_force(int vflag)
{
  post_force(vflag);
}
...
double FixSMDIndent::compute_scalar()
{
...
double FixSMDIndent::compute_vector(int n)
{
  // only sum across procs one time
...
void FixSMDIndent::options(int narg, char **arg)
{
